package pe.edu.cibertec.restaurantcompose.ui.criollo
...
import pe.edu.cibertec.restaurantcompose.data.repository.CriolloRepository
import pe.edu.cibertec.restaurantcompose.util.Result


@Composable
fun CriolloList(navController: NavController) {
    ...
    val criolloRepository = CriolloRepository()
    ...
    criolloRepository.getCriollo { result ->
